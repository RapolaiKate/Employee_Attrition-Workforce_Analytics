...
-- Database Setup and Total Employee Count
CREATE DATABASE
employee_attrition;
...
-- Calculate thr Total number of Employees in the Database
SELECT COUNT(*) AS total_employees
FROM employee;

-- Preview the first 10 records in the Employee Table
SELECT *
FROM  employee
LIMIT 10;
...
-- Attrition Analysis by Department Group
SELECT Department,
COUNT(*) AS total_employees,
SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) AS employees_left,
...
-- Attrition Analysis by Job Level Group 
SELECT JobLevel,
COUNT(*) AS total_employees,
SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) AS employees_left,
ROUND( SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) * 100.0 / COUNT(*), 2) AS attrition_rate
...
-- Attrition Analysis by Overtime Group 
SELECT OverTime,
COUNT(*) AS total_employees,
SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) AS employees_left,
ROUND( SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) * 100.0 / COUNT(*), 2) AS attrition_rate
...
-- Attrition Analysis by Job Satisfaction Group 
...
-- Attrition Analysis by Work Life Balence Group
...
-- Attrition Analysis by Income Group
SELECT
CASE
...
-- Attrition Analysis by Tenure Group 
SELECT
CASE
...
-- Attrition Analysis by Promotion 
SELECT
PromotionLast5Years,
COUNT(*) AS total_employees,
SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) AS employees_left,
...
-- Attrition Analysis by Performance
SELECT
PerformanceRating,
COUNT(*) AS total_employees,
SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) AS employees_left,
...
-- Attrition Analysis by Training Hours
SELECT
CASE
...
-- Attrition Analysis by Distance from Home
SELECT
CASE
...
-- Overall Employee Attrition Summary
SELECT
COUNT(*) AS total_employees,
SUM(CASE WHEN Attrition = 'Yes' THEN 1 ELSE 0 END) AS employees_left,
...
-- Data Row and Employee ID Validation
SELECT
COUNT(*) AS total_rows,
